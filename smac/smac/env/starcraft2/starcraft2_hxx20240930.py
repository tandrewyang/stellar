...
class StarCraft2Env(MultiAgentEnv):
    ...
    def get_obs_agent(self, agent_id):
        ...
        if unit.health > 0:  # otherwise dead, return all zeros
            ...
            for e_id, e_unit in self.enemies.items():
                ...
                if (
                    ...
                    if self.obs_all_health:
                        ...
                        ind += 1
                        if self.shield_bits_enemy > 0 and e_unit in (74, 73, 4):
            ...
            for i, al_id in enumerate(al_ids):
                ...
                if (
                    ...
                    if self.obs_all_health:
                        ...
                        ind += 1
                        if self.shield_bits_ally > 0 and al_unit in (74, 73, 4):
            ...
            if self.obs_own_health:
                ...
                ind += 1
                if self.shield_bits_ally > 0 and unit in (74, 73, 4):
    ...
    def get_unit_type_id(self, unit, ally):
        ...
        if ally:  # use new SC2 unit types
            ...
            if self.map_type == "stalkers_and_zealots":
                ...
                # id(Marine) = 48, id(Marauder) = 51, id(Medivac) = 54
                if unit.unit_type == 51:
                    type_id = 0
                elif unit.unit_type == 48:
                    type_id = 1
    ...
    def enemy_nexus_destroyed(self):
        """Check if the enemy Nexus has been destroyed."""
    ...
    def update_units(self):
        ...
        for e_id, e_unit in self.enemies.items():
            ...
            for unit in self._obs.observation.raw_data.units:
                if e_unit.tag == unit.tag:
                    ...
                    updated = True
                    if e_unit.unit_type not in (59,61,133):
                        n_enemy_alive += 1
                    break
        ...
        #):
        if (
            n_ally_alive > 0 and (n_enemy_alive == 0 or self.enemy_nexus_destroyed())
            or self.only_medivac_left(ally=False)
        ):
            return 1  # won
