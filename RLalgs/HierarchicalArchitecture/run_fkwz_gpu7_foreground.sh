#!/bin/bash
# HierarchicalArchitecture - 训练fkwz地图，GPU 7，前台输出日志
...
echo "=========================================="
echo "HierarchicalArchitecture 训练 - fkwz"
echo "=========================================="
echo "地图: $MAP_NAME"
echo "GPU: $GPU_ID"
echo "种子: $SEED"
...
# 创建日志目录
LOG_DIR="results/train_logs/${MAP_NAME}_hierarchical_qmix"
mkdir -p "$LOG_DIR"

# 前台运行，同时输出到终端和日志文件
CUDA_VISIBLE_DEVICES=$GPU_ID python3 src/main.py \
    --config=hierarchical_qmix \
    --env-config=sc2te \
